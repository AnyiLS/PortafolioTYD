...
import Image from '../assets/gaming-boy.png';
            ...
            <div className='container mx-auto'>
                <div className='flex flex-col gap-y-8 lg:flex-row lg:items-center lg_gap-x-12'>
                    ...
                    <div className='flex-1 text-center lg:text-left'>
                        ...
                        >
                            En este portafolio encontrarás ejemplos de proyectos
                            desarrollados por el grandioso equipo de{' '}
                            <strong>EML</strong>. Siéntete libre de explorar el
                            contenido y ¡disfruta tu estadía en la página!
                        </motion.p>
                        <motion.div
